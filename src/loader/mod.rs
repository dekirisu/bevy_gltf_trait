...
use std::{
    io::Error, marker::PhantomData, path::{Path, PathBuf}
};
...
use crate::{
    ext::*, vertex_attributes::convert_attribute, Gltf, GltfAssetLabel, GltfExtras, GltfMaterialExtras, GltfMaterialName, GltfMeshExtras, GltfNode, GltfSceneExtras, GltfSkin
};
...
fn load_node <G:GltfTrait> (
    ...
    let mut node = child_spawner.spawn(Visibility::default());
